	...
	function projectDataForm() {
		$
				.ajax({
					...
					url : "/tsied_front/project/find-advert-detail?adProject="
						...
						$('#s_chart').highcharts(
								{
									...
									title : {
										text : '2015年12月1日2016年1月1日公司内部新增用户'
									},
									subtitle : {
										text : '对应广告分析'
									},
				...
				<ul class="nav ace-nav">
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							src="<%=request.getContextPath()%>/assets/avatars/user.jpg"
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-5">
										<span class="block input-icon input-icon-right"> <select
											name="indexType" class="number" id="indexType">
